...
class JournalVisionClient:
    ...
    def _build_payload(self, image_path: Path, machine_codes: list[str]) -> dict[str, Any]:
        ...
        instruction = (
            ...
            "Đọc mã thiết bị, ngày, thời gian bắt đầu/kết thúc, nội dung công việc, khối lượng, đơn vị, "
            "vị trí thi công và họ tên người vận hành. Ngày bắt buộc dùng YYYY-MM-DD; giờ dùng HH:MM:SS. "
            ...
            "total_minutes, work_content, quantity, unit, work_location, operator_name, confidence, raw_data}]}."
        )
        return {
            "model": self.model,
            "messages": [{
