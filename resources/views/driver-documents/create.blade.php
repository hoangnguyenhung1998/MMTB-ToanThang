...
@section('content')
    <div class="container-fluid">
        <h1 class="h4 mb-3">Thêm giấy tờ tài xế: {{ $driver->name }}</h1>
        ...
        <form method="POST" action="{{ route('driver-documents.store', $driver) }}" enctype="multipart/form-data" class="card p-3">
            @csrf
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select name="doc_type" class="form-select" required>
                        ...
                        @foreach (['CCCD mặt trước', 'CCCD mặt sau', 'Thẻ ATLĐ', 'Giấy khám sức khỏe', 'Bảo hiểm tai nạn', 'Chứng chỉ nghề', 'Hợp đồng', 'Phiếu giao việc'] as $type)
            ...
            <div class="mt-3">
                ...
                <a class="btn btn-outline-secondary" href="{{ route('driver-documents.index', $driver) }}">Quay lại</a>
            </div>
        </form>
    </div>
