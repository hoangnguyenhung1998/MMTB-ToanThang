...
<div class="page-shell">
    ...
    <div class="row g-4"><div class="col-lg-8">
        ...
        <div class="app-card p-4 mb-4"><h3>Tài liệu nguồn ({{ $case->documents->count() }})</h3>@foreach($case->documents as $doc)<div class="border rounded p-2 mb-2"><strong>{{ $doc->document_type }}</strong><div class="small text-muted text-break">{{ $doc->original_name }}</div><span class="small">{{ $doc->extraction_status }}</span></div>@endforeach</div>
